	...
	BURLO )
		case \${pool_mode} in
        	CHROM )
				...
				for chr in \${chr_pool[@]}
                do
					echo "bash \${hs}/1718.GATK4_step1718.sh \${param_file} \${chr}" | qsub -N G4s1718_\${variantdb} -hold_jid G4s1616_\${variantdb} -o \${lg}/\${variantdb}/g1718_\${variantdb}_\\\$JOB_ID.log -e \${lg}/\${variantdb}/g1718_\${variantdb}_\\\$JOB_ID.error -m ea -M \${mail} -cwd -l h_vmem=\${sge_m} -q \${sge_q} 

                done

				#pipe step 19a
				#Merge chr level files to run vqsr
				jid_step_19a19a=\$(qsub -N G4s19a19a_\${variantdb} -terse -cwd -l h_vmem=\${sge_m_j3} -q \${sge_q} -hold_jid G4s1718_\${variantdb}* -o \${lg}/\${variantdb}/g19a19a_\${variantdb}_\\\$JOB_ID.log -e \${lg}/\${variantdb}/g19a19a_\${variantdb}_\\\$JOB_ID.error -m ea -M \${mail} \${hs}/19a19a.GATK4_step19a19a.sh \${param_file})
				...
				echo "bash \${hs}/1919.GATK4_step1919.sh \${param_file}" | qsub -N G4s1919_\${variantdb} -hold_jid \${jid_step_19a19a} -o \${lg}/\${variantdb}/g1919_\${variantdb}_\\\$JOB_ID.log -e \${lg}/\${variantdb}/g1919_\${variantdb}_\\\$JOB_ID.error -m ea -M \${mail} -cwd -l h_vmem=\${sge_m_j3} -q \${sge_q} 

				#VQSR
				#pipe step 20
				#IN Site cohort Site Only raw-VCF OUT snp tranches, snp recal /// VariantRecalibrator

				echo "bash \${hs}/2020.GATK4_step2020.sh \${param_file}" | qsub -N G4s2020_\${variantdb} -hold_jid \${jid_step_19a19a} -o \${lg}/\${variantdb}/g2020_\${variantdb}_\\\$JOB_ID.log -e \${lg}/\${variantdb}/g2020_\${variantdb}_\\\$JOB_ID.error -m ea -M \${mail} -cwd -l h_vmem=\${sge_m_j4} -q \${sge_q} 
			;;
			SAMPLE )
				#Pre-VQSR
				#pipe step 17-18
