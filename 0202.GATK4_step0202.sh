...
java -jar ${PICARD} ValidateSamFile I=${fol1}/${bBAM} MODE=SUMMARY TMP_DIR=${tmp}/
echo "- END -"

#Stat
echo
# cd ${fol1}/
${SAMTOOLS} flagstat ${fol1}/${bBAM}
echo
${SAMTOOLS} view -H ${fol1}/${bBAM} | grep '@RG'
echo
${SAMTOOLS} view -H ${fol1}/${bBAM} | grep '@PG'
echo "- END -"
