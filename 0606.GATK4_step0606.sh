...
${GATK4} --java-options ${java_opt2x} -XX:ParallelGCThreads=1 BaseRecalibrator -R ${GNMhg38} -I ${fol1}/${fBAM} --use-original-qualities -O ${fol3}/${c_bqsrrd} --known-sites ${DBSNP138} --known-sites ${INDELS} --known-sites ${OTGindels} -ip 100 -L ${f1}
echo "- END -"
