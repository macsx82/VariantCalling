...
function build_template_pooled_SGE(){
...
#21589 intervalli: Whole genes regions (old version, dismissed); hg38RefSeqCurGenes_ID.intervals; hg38RefSeqCurGenes_noID.intervals
#WGS intervals fo variant calling, from GATK bundle
WGS_GATK=/home/cocca/resources/hg38/wgs_calling_regions.hg38.bed_intervals.list	#I want this to be used as a job array parameter
																									# so this will be a list of bed files for the calling step
...
# New variables with different values can be added as long as
# they are also added to the corresponding runner file.
cluster_man="BURLO" #Specify the cluster manager:BURLO or CINECA
exec_host=$3 #we can specify here the exec host to use in tmp mode var calling step to store the most of the data
sge_q=$4 #in var caller tmp mode, here we should need only the queue name, without host spec
sge_q_vcall=\${sge_q} #in var caller tmp mode, here we should need only the queue name, without host spec
sge_m_u=3G #this mem requirement is for the mem-per-cpu option in slurm
...
# ################### Known resources ###################
GNMhg38=/shared/resources/hgRef/hg38/Homo_sapiens_assembly38.fasta
DBSNP138=/home/cocca/resources/hg38/dbsnp_138.hg38.vcf.gz
DBSNP_latest=/home/cocca/resources/hg38/dbsnp_151.hg38.vcf.gz
INDELS=/home/cocca/resources/hg38/Homo_sapiens_assembly38.known_indels.vcf.gz
OTGindels=/home/cocca/resources/hg38/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz
OTGsnps=/home/cocca/resources/hg38/1000G_phase1.snps.high_confidence.hg38.vcf.gz
HAPMAP=/home/cocca/resources/hg38/hapmap_3.3.hg38.vcf.gz
OMNI=/home/cocca/resources/hg38/1000G_omni2.5.hg38.vcf.gz
AXIOM=/home/cocca/resources/hg38/Axiom_Exome_Plus.genotypes.all_populations.poly.hg38.vcf.gz

# ### - PATH TOOLs - ###
# PICARD=/share/apps/bio/picard-2.17.3/picard.jar # v2.17.3
BWA=/share/apps/bio/bin/bwa             # v0.7.17-r1188
SAMTOOLS=/share/apps/bio/miniconda2/bin/samtools  # v1.9-2-g02d93a1
BCFTOOLS=/share/apps/bio/miniconda2/bin/bcftools  # v1.9-18-gbab2aad
# GATK4=/share/apps/bio/gatk-4.1.0.0/gatk     # v4.1.0.0
