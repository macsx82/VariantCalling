...
case \${cluster_man} in
	BURLO )
		...
		for chr in \${chr_pool[@]}
        do
			#echo "bash \${hs}/2121.GATK4_step2121.sh \${param_file} \${chr}" | qsub -N G4s2121_\${variantdb} -hold_jid G4s1919_\${variantdb} -hold_jid G4s2020_\${variantdb} -o \${lg}/\${variantdb}/g2121_\${variantdb}_\\\$JOB_ID.log -e \${lg}/\${variantdb}/g2121_\${variantdb}_\\\$JOB_ID.error -m ea -M \${mail} -cwd -l h_vmem=\${sge_m_j1} -q \${sge_q} 
			echo "bash \${hs}/2121.GATK4_step2121.sh \${param_file} \${chr}" | qsub -N G4s2121_\${variantdb}_\${chr} -o \${lg}/\${variantdb}/g2121_\${variantdb}_\${chr}_\\\$JOB_ID.log -e \${lg}/\${variantdb}/g2121_\${variantdb}_\${chr}_\\\$JOB_ID.error -m ea -M \${mail} -cwd -l h_vmem=\${sge_m_j1} -q \${sge_q} 
