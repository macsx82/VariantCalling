...
${GATK4} --java-options ${java_opt2x} HaplotypeCaller -R ${GNMhg38} -I ${fol4}/${applybqsr} -O ${fol5_tmp}/${c_gv} -L "${f1}" -ip ${ip1} --max-alternate-alleles ${maa} -ERC GVCF
echo "- END -"
...
rsync -av -P ${fol5} ${USER}@${exec_host}:${fol5_host}/.
