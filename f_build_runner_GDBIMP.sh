	...
	CINECA )
		...
		case \${pool_mode} in
            CHROM )
				...
				jid_step_1414_m=\$(sbatch --partition=\${sge_q} --account=uts19_dadamo --array=1-\${size} --time=24:00:00 -e \${lg}/%A_g1414_\${SM}_%a.error -o \${lg}/%A_g1414_\${SM}_%a.log --mem=\${sge_m_dbi} -J "G4s1414_\${SM}" --dependency=afterok:\${jid_step_1313} --get-user-env -n \${rt} --mail-type END,FAIL --mail-user \${mail} \${hs}/runner_job_array_CINECA.sh -s \${hs}/1414.GATK4_step1414.sh \${vdb_interval} \${param_file}
				...
				#pipe step 15, job-array
				#IN gVCFDB OUT raw-VCFs /// GenotypeGVCFs
				jid_step_1515_m=\$(sbatch --partition=\${sge_q} --account=uts19_dadamo --array=1-\${size} --time=24:00:00 -e \${lg}/%A_g1515_\${SM}_%a.error -o \${lg}/%A_g1515_\${SM}_%a.log --mem=\${sge_m_dbi} -J "G4s1515_\${SM}" --dependency=afterok:\${jid_step_1414} --get-user-env -n 1 --mail-type END,FAIL --mail-user \${mail} \${hs}/runner_job_array_CINECA.sh -s \${hs}/1515.GATK4_step1515.sh \${vdb_interval} \${param_file}
